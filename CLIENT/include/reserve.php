               ...
               <div class="card">
                  ...
                  <form class="forms-sample" action="action/reserve_verification.php" method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="email" id="exampleInputUsername1" value="<?php echo $lrow['email']; ?>" readonly="">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputUsername1">Phone</label>
                      <input type="number" class="form-control" name="phone" id="exampleInputUsername1" value="<?php echo $lrow['phone']; ?>" readonly="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Fullname</label>
                      <input type="text" class="form-control" name="fullname" id="exampleInputEmail1" value="<?php echo $lrow['fullname']; ?>" readonly="">
                    </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="pax" id="QTY" min="<?php echo $row['promo_min_pax']; ?>" max="<?php echo $row['promo_max_pax']; ?>" onKeyUp="multiply()">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit"  name="checkout"  class="btn btn-primary mr-2" style="width:100%;">PROCEED TO CHECKOUT</button>
