...
if(isset($_POST['recover'])){
      ...
      if ($num_row > 0) 
        {
          ...
          $status = 'UNUSED'; 
           ...
           mysqli_query($conn,"UPDATE client SET code = '$code' WHERE user_id = '$user_id'"); 
 ...
 require 'mailler/autoload.php';
      ...
      $subject = 'JOMER VENTURES | EMAL RECOVERY : '.strtoupper($email).' ';
...
<head>
  <meta charset="UTF-8">
  <title>JOMER VENTURES | EMAL RECOVERY </title>
...
<body class="">
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body">
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      ...
                      <p>AN ATTEMP TO CHANGE PASSWORD '.strtoupper($date_attemp).'</p><br>
    ...
    header('location: ../index.php?view=CHANGE&email='.$email);
