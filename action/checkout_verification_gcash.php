...
if(isset($_POST['checkout'])){
        ...
        $lrow=mysqli_fetch_array($result);
          ...
          mysqli_query($conn,"INSERT INTO proceed_to_pay (email, ref, phone, fullname, booking_date, price, pax, price_to_pay, pickup, code, promo_id, status, mode, date_created) VALUES ('$email', '$ref', '$phone', '$fullname', '$booking_date', '$price', '$pax', '$price_to_pay', '$pickup', '$code', '$promo_id', '$status', '$mode', '$date_created')");  
