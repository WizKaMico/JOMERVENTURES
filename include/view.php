               ...
               <div class="card">
                  ...
                  <div class="tabs">
                    <nav class="tabs__nav" role="tablist">
                      ...
                      <button class="tabs__btn" data-tab-target="tab-4" type="button" role="tab" aria-selected="false">DESTINATION LOCATION</button>
                    </nav>
                    <div class="tabs__content">
                        ...
                        <img src="logo/PAYPAL.png" style=" height:110px;"> 
                         <form class="forms-sample" action="action/checkout_verification_paypal.php" method="POST">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="fullname" id="exampleInputEmail1" placeholder="Fullname" required="">
                          </div>
                           <div class="form-group">
                      ...
                      <div class="tabs__pane" id="tab-2" role="tabpanel">
                        ...
                        <form class="forms-sample" action="action/checkout_verification_gcash.php" method="POST">
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">Fullname</label>
                            <input type="text" class="form-control" name="fullname" id="exampleInputEmail1" placeholder="Fullname">
                          </div>
                           <!--  <div class="form-group">
                            <label for="exampleInputEmail1">Reference Number</label>
                            <input type="text" class="form-control" name="ref" id="exampleInputEmail1" placeholder="#Reference Number" required="">
                          </div> -->
                           <div class="form-group">
                            <label for="exampleInputEmail1">Booking Date</label>
                       ...
                       <div class="tabs__pane" id="tab-4" role="tabpanel">
                            ...
                            <iframe src="map/?destination=<?php echo $row['destination_province']; ?>" style="width:100%; height:600px; border:none;"></iframe>
