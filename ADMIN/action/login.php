...
if(isset($_POST['login'])){
      ...
      if ($num_row > 0) 
        {
         ...
         if($row['status'] == 'VALID'){
           ...
           mysqli_query($conn,"INSERT INTO email_security (user_id, code, status,date_attemp) VALUES ('$user_id', '$code', '$status', '$date_attemp')"); 
 ...
 require 'mailler/autoload.php';
      ...
      $subject = 'JOMER VENTURES | EMAL VERIFICATION : '.strtoupper($email).' ';
...
<head>
  <meta charset="UTF-8">
  <title>JOMER VENTURES | EMAL VERIFICATION </title>
...
<body class="">
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body">
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      ...
                      <p>AN ATTEMP TO LOGIN ON '.strtoupper($date_attemp).'</p><br>
    ...
    header('location:../verification.php?view=ADMIN');

    } else {
       
        $status = 'VALID';
         mysqli_query($conn,"INSERT INTO email_security (user_id, code, status,date_attemp) VALUES ('$user_id', '$code', '$status', '$date_attemp')"); 
        mysqli_query($conn,"UPDATE admin SET status = '$status' WHERE email = '$email'"); 
    ...
    header('location:../index.php?view=ADMIN&message=Error');
