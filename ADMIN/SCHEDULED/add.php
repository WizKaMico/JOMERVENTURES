...
if(isset($_POST['bulk_update_submit'])){
    ...
    $days = $_POST['days'];
    foreach($idArr as $id){
        $sql = "SELECT * FROM proceed_to_pay WHERE id = '$id'";
        ...
        if($reason == 'REMAINING_DAYS'){	      

	 require 'mailler/autoload.php';
	    
	      $subject = 'JOMER VENTURES | EMAL REGARDING | '.strtoupper($reason).' : '.strtoupper($email).' ';
	                ...
	                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
	                  <tr>
	                    <td>
	                      ...
	                      <p>This is an an automated mail regarding your booking on '.strtoupper($booking_date).'</p><br>
