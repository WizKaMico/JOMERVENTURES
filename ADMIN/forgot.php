        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="action/recover.php" method="POST">
                <div class="form-group">
                  <input type="email" name="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email" required="">
                </div>
                <div class="mt-3">
                  <input type="submit" name="recover" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="RECOVER">
