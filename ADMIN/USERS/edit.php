...
if(isset($_POST['edit'])){
   ...
   mysqli_query($conn,"UPDATE users SET email = '$email', password = '$pass', fullname = '$fullname', status = '$status' WHERE user_id = '$user_id'");  
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      ...
                      <p>JOMER VENTURES | UPDATED ACCOUNT</p><br>
