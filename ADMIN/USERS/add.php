...
if(isset($_POST['add'])){
	...
	$date_created = date('Y-m-d');
          ...
          mysqli_query($conn,"INSERT INTO users (email, password, fullname, code, status, date_created) VALUES ('$email', '$pass', '$fullname', '$code', '$status', '$date_created')");  
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      ...
                      <p>JOMER VENTURES | EMAIL VERIFICATION</p><br>
